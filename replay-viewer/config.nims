...
# use-after-free fixed in lux_replay.nim (emscripten_exit_with_live_runtime)
...
# lux_error_len(). Aborting keeps linear memory intact, and the page reads
# lux_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "lux_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_lux_load_replay,_lux_frame,_lux_input,_lux_packet_ptr,_lux_packet_len,_lux_mismatch_tick,_lux_error_ptr,_lux_error_len,_lux_stage_ptr,_lux_stage_len
  """).replace("\n", " ")
)
