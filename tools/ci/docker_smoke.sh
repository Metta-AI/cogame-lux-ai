...
# Substitute: lux-ai, coworld-lux-ai, 2.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-lux-ai:ci)
#   SMOKE_SLUG                 game slug                        (lux-ai)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/lux-ai)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/lux-ai-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-lux-ai:ci}}"
slug="${SMOKE_SLUG:-lux-ai}"
